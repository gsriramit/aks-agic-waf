...
# Note: CRDs include the AGIC related resource kinds. However the deployment creates an AzureIngressProhibitedTarget called "prohibit-all-targets"
...
# TODO - move to a separate file and invoke as a file param
cat <<EOF | kubectl apply -f -
apiVersion: "appgw.ingress.k8s.io/v1"
kind: AzureIngressProhibitedTarget
metadata:
  name: bua002-contoso-com
spec:
  hostname: BUA002.contoso.com
EOF
